...
At the request of the CRU management team, the CRU DEI committee\footnote{Committee members are Graziella DiRenzo (MA), Angela Fuller (NY), J. Barry Grand (HQ); Mark Henderson (CA), Amanda Rosenberger (TN), Reynaldo Patino (TX), Mark Scheuerell (WA), Abby Powell (Chair; FL), Wendy Turner (WI)} developed an online survey to gather information about the mentoring needs and services of unit scientists and supervisors. The committee emailed a [link to the survey](https://forms.gle/nFUXpAcgTFv6xoQC8) via Shana Coulby in mid-October and asked people to respond within 3 weeks. Ultimately, we received responses from 60 individuals, which are summarized in this report.
