...
The CRU DEI committee\footnote{DEI committee members are Graziella DiRenzo (MA), Angela Fuller (NY), J. Barry Grand (HQ); Mark Henderson (CA), Reynaldo Patino (TX), Abby Powell (Chair; FL), Amanda Rosenberger (TN), Mark Scheuerell (WA), Wendy Turner (WI).} feels that a mentoring program within the CRU program will help us become an inclusive and welcoming environment to all of our employees, and help with retention. Thus, the committee developed an online survey to gather information about the mentoring needs and services of unit scientists. The committee emailed a [link to the survey](https://forms.gle/nFUXpAcgTFv6xoQC8) via Shana Coulby in mid-October and asked people to respond within 3 weeks. Ultimately, we received responses from 60 individuals, which are summarized in this report.
